/**
 * Всякие полезности, которых нет изкоробки в MS JScript Com Object
 */
...
function ObjectSerialize(object) {
    ...
    if (type === 'object') {
        ...
        for (element in object) {
            serializedCode += "[" + type + ":" + element + ObjectSerialize(object[element]) + "]";
        }
...
function ObjectHashCode(object) {
    ...
    return md5(ObjectSerialize(object));

}

/**
 * Возвращает Ключи оъекта
 * @param object
 * @returns {Array}
 * @constructor
 */
